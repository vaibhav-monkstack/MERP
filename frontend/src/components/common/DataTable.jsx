          ...
          <tr className="bg-gray-50/50">
            {headers.map((header) => (
              <th 
                ...
                className={`px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-widest border-bottom border-gray-100 ${header.sortable ? 'cursor-pointer hover:text-indigo-600 transition-colors' : ''} ${header.align === 'right' ? 'text-right' : ''}`}
              >
